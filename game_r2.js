...
*/
    ...
    for(i=0;i<npc.length;i++)  {
        ...
        else if (disc.state == 2) fillRectangle(npc[i].disc.pos.x,npc[i].disc.pos.y, 20, 20, makeColor(0.0,0.0,1.0));
        else if (disc.state == 1) fillRectangle(npc[i].disc.pos.x,npc[i].disc.pos.y, 20, 5, makeColor(0.0,0.0,1.0));
    }
